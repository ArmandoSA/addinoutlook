 ...
 */
function startDebugging(manifestPath, appType, app, debuggingMethod = defaultDebuggingMethod(), sourceBundleUrlComponents, devServerCommandLine, devServerPort, packagerCommandLine, packagerHost, packagerPort, enableDebugging = true, enableLiveReload = true, openDevTools = false) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
