...
function start(manifestPath, platform, command) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield start_1.startDebugging(manifestPath, appTypeToDebug, app, debuggingMethod, sourceBundleUrlComponents, devServer, devServerPort, packager, packagerHost, packagerPort, enableDebugging, enableLiveReload, openDevTools);
        }
        catch (err) {
